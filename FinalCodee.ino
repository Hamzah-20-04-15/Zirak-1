...
void setup() {
  ...
  ledcAttach(LED_OnBoard, PWM_LED_Freq, PWM_LED_Channel);
  ...
  ledcAttach(Motor_R_PWM_Pin, PWM_Mtr_Freq, PWM_Channel_Mtr_R);
  ledcAttach(Motor_L_PWM_Pin, PWM_Mtr_Freq, PWM_Channel_Mtr_L);
